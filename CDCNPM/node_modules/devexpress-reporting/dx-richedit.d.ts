...
declare module DevExpress.Analytics {
    ...
    module Internal {
        ...
        function roundingTwoDecimals(value: number, useFloor?: boolean): number;
        ...
        module Wizard {
            ...
            module Internal {
                ...
                interface ISqlQueryControl {
                    ...
                    setQuery: (query: Data.Utils.ISqlQueryViewModel, isInProcess?: ko.Observable<boolean>) => JQueryPromise<any>;
                ...
                class StoredProceduresQueryControl extends Analytics.Utils.Disposable implements ISqlQueryControl {
                    ...
                    setQuery(query: Data.StoredProcQuery): JQuery.Promise<any, any, any>;
...
declare module DevExpress.Reporting {
    ...
    module Viewer {
        ...
        module Internal {
            ...
            function createPreviewModel(viewerModel: Utils.IWebDocumentViewerModel, element: Element, callbacks?: Utils.IPreviewCustomizationHandler, applyBindings?: boolean): JQuery.Deferred<any, any, any>;
            function initPreviewModel(previewModel: any, viewerModel: Utils.IWebDocumentViewerModel): void;
        }
        module Parameters {
        ...
        module Widgets {
            ...
            var predefinedDateRanges: IDateRangeEditorItem[];
        ...
        class JSReportViewerBinding extends DevExpress.Analytics.Internal.JSDesignerBindingCommon<JSReportViewer> {
            ...
            _createModel(element: any): JQuery.Deferred<any, any, any>;
    ...
    module Chart {
        module Internal {
            ...
            module Widgets {
                ...
                class PositionSeriesLabelEditor extends Analytics.Widgets.Editor {
            ...
            var editorTemplates: {
                ...
                comboboxPositionSeriesLabel: {
                    header: string;
                    editorType: typeof Widgets.PositionSeriesLabelEditor;
                };
                panes: {
                    header: string;
                };
            ...
            var barPositionValues: {
                value: string;
                displayValue: string;
                localizationId: string;
            }[];
            var piePositionValues: {
                value: string;
                displayValue: string;
                localizationId: string;
            }[];
            var funnelPositionValues: {
                value: string;
                displayValue: string;
                localizationId: string;
            }[];
            ...
            var emptyChartTextSerializationsInfo: Analytics.Utils.ISerializationInfoArray;
            var emptyChartText: Analytics.Utils.ISerializationInfo;
            ...
            var backImage: Analytics.Utils.ISerializationInfo;
    ...
    module Designer {
        ...
        module Internal {
            ...
            class ObjectDataSourceEditor extends DataSourceEditorBase {
                static createObjectDataSourceInfo(objectDataSourceWizard: Analytics.Wizard.IObjectDataSourceWizardState, objectDataSource: Analytics.Data.ObjectDataSource, base64?: string): JQueryPromise<IDataSourceInfo>;
        ...
        module Widgets {
            ...
            class PageBreakBandEditor extends Analytics.Widgets.Editor {
                constructor(info: DevExpress.Analytics.Utils.ISerializationInfo, level: any, parentDisabled?: ko.Computed<boolean>, textToSearch?: any);
                values: ko.Computed<{
                    displayValue: string;
                    value: string;
            ...
            class FormatStringEditor extends Analytics.Widgets.Editor {
                readonly actions: Analytics.Widgets.IFormatStringEditorActions;
                readonly customPatterns: {
                    [key: string]: string[];
                };
            }
            ...
            class ReportUrlEditor extends Analytics.Widgets.Editor {
                private _initUrls;
                constructor(info: DevExpress.Analytics.Utils.ISerializationInfo, level: any, parentDisabled?: ko.Computed<boolean>, textToSearch?: any);
                getValues(urls: ko.ObservableArray<IKeyValuePair<string>>, tab: ko.Observable<DevExpress.Reporting.Designer.Tools.INavigateTab>): ko.Computed<DataSource>;
                updateUrls(): void;
            ...
            var editorTemplates: {
                formatEditor: {
                    header: string;
                    editorType: typeof FormatStringEditor;
                };
                dataSource: {
                    header: string;
                ...
                comboboxPageBreak: {
                    header: string;
                    editorType: typeof PageBreakBandEditor;
                };
                fontUndo: {
                    header: string;
                    content: string;
        ...
        module Internal {
            ...
            function getOrCreateBandForToC(reportModel: Controls.ReportViewModel, createNew?: boolean): {
                band: any;
                canAdd: any;
            };
            ...
            class ReportToolboxDragDropHandler extends Analytics.Internal.ToolboxDragDropHandler {
                ...
                doStopDrag(ui: any, draggable: any): void;
                addControl(control: Analytics.Elements.IElementViewModel, dropTargetSurface: Analytics.Internal.ISelectionTarget, size: any): void;
                onComponentAdded: (e: Utils.IComponentAddedEventArgs) => void;
            }
            var eventArgsTypes: {
                [key: string]: string;
            ...
            class ReportDataSourceService {
                ...
                static getObjectDataSourceBase64(json: Analytics.Wizard.IObjectDataSourceWizardState): JQueryPromise<string>;
                static editObjectDataSourceParameters(json: Analytics.Wizard.IObjectDataSourceWizardState, base64: string): JQueryPromise<string>;
        ...
        module Internal {
            function isHeaderOrFooterBandType(band: any): any;
            function canAddToc(reportModel: Controls.ReportViewModel): any;
            function getExistTableOfContents(band: Bands.BandViewModel | Controls.XRControlViewModel): Controls.XRControlViewModel;
        ...
        module Bands {
            ...
            module Metadata {
                ...
                var pageBreakWithoutAfterValues: {
                    value: string;
                    displayValue: string;
                    localizationId: string;
                }[];
                var pageBreakValues: any[];
            ...
            module RichEdit {
                module Internal {
                    ...
                    class XRRichEditControlModel extends Analytics.Utils.Disposable {
                        ...
                        executeCommand(commandId: dxRichEdit.CommandId, parameter?: any, setFocus?: boolean): void;
                    ...
                    class RichEditFontModel extends DevExpress.Analytics.Widgets.Internal.FontModel {
                        ...
                        protected applyCommand(commandId: dxRichEdit.CommandId, parameter?: any): void;
                    }
                    ...
                    module Toolbar {
                        ...
                        interface ICommandOptions {
                            commandManager: any;
                            executeCommand: (command: dxRichEdit.CommandId, params?: any, setFocus?: boolean) => void;
                        ...
                        abstract class ComponentCommon extends Analytics.Utils.Disposable implements IComponentBase {
                            ...
                            _updateStateInternal(commandIdMap?: Record<number, boolean>): void;
                            protected _executeCommand(value?: any, command?: dxRichEdit.CommandId): any;
                        ...
                        class ComponentButtonGroup extends ComponentCommon {
                            ...
                            getCommand(item?: IItem): dxRichEdit.CommandId;
                            protected updateState(): void;
                        ...
                        class ToolbarSurface extends Analytics.Utils.Disposable {
                            ...
                            onCommandStateChanged(sender: dxRichEdit.RichEdit, args: dxRichEdit.CommandStateChangedEventArgs): void;
                            onContentReady: (e: {
                                element: any;
                                component: Viewer.Widgets.Internal.IPopupComponent;
                                model: any;
