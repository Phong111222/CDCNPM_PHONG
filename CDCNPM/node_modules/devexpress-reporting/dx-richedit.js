                    ...
                    (function (Internal) {
                                ...
                                if (newRtfString === undefined) {
                                    var openSaveAction = function () {
                                        _this.richEdit.openDocument(btoa(_this.surface._control.name()), DevExpress.RichEdit.DocumentFormat.PlainText, function () {
                                            ...
                                            rich.executeCommand(DevExpress.RichEdit.HomeTabCommandId.ChangeFontName, fontName);
                                            rich.executeCommand(DevExpress.RichEdit.HomeTabCommandId.ChangeFontSize, fontSize);
                                            rich.history.clear();
                        ...
                        var XRRichEditControlModel = (function (_super) {
                            ...
                            function XRRichEditControlModel(element, inlineControl, selected) {
                                ...
                                _this.disableCommands = [
                                    DevExpress.RichEdit.HomeTabCommandId.Find,
                                    DevExpress.RichEdit.HomeTabCommandId.Replace,
                                ];
                            ...
                            XRRichEditControlModel.prototype.getFonts = function () {
                                return Object.keys(ko.unwrap(DevExpress.Analytics.Widgets.Internal.availableFonts)).sort(function (a, b) { return a < b ? -1 : 1; });
                            };
                            ...
                            XRRichEditControlModel.prototype.createToolbar = function () {
                                this._toolbar = new Toolbar.ToolbarSurface({
                            ...
                            XRRichEditControlModel.prototype.newDocumentNative = function (onResultReady) {
                                ...
                                this.executeCommand(DevExpress.RichEdit.FileTabCommandId.CreateDocument);
                            };
                        ...
                        var RichEditPaddingModelWrapper = (function (_super) {
                            ...
                            RichEditPaddingModelWrapper.prototype._setPaddings = function () {
                                ...
                                ["left", "right", "top", "bottom"].forEach(function (side) { return paddings[side] = Designer.Internal.recalculateUnit(_this._paddingModel[side]() || 0.01, _this._paddingModel.dpi()); });
                        ...
                        var RichEditFontModel = (function (_super) {
                            ...
                            function RichEditFontModel(value, richEdit, foreColor, controller) {
                                ...
                                for (var _i = 0, _a = [
                                    [_this.family, function (fontName) { return _this.applyCommand(DevExpress.RichEdit.HomeTabCommandId.ChangeFontName, fontName); }],
                                    [_this.size, function (size) { return _this.applyCommand(DevExpress.RichEdit.HomeTabCommandId.ChangeFontSize, size); }],
                                    [foreColor, function (foreColor) { return _this.applyCommand(DevExpress.RichEdit.HomeTabCommandId.ChangeFontForeColor, foreColor); }],
                                    [_this.modificators.bold, function (bold) { return _this.applyCommand(DevExpress.RichEdit.HomeTabCommandId.ToggleFontBold, bold); }],
                                    [_this.modificators.italic, function (italic) { return _this.applyCommand(DevExpress.RichEdit.HomeTabCommandId.ToggleFontItalic, italic); }],
                                    [_this.modificators.strikeout, function (strikeout) { return _this.applyCommand(DevExpress.RichEdit.HomeTabCommandId.ToggleFontStrikeout, strikeout); }],
                                    [_this.modificators.underline, function (underline) { return _this.applyCommand(DevExpress.RichEdit.HomeTabCommandId.ToggleFontUnderline, underline); }],
                                ]; _i < _a.length; _i++) {
                                    var data = _a[_i];
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        items: [
                                                            { actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.ToggleParagraphAlignmentLeft, icon: " dxre-icon-AlignLeft", hint: DevExpress.Analytics.Utils.getLocalization("Align Text Left", "XtraRichEditStringId.MenuCmd_ParagraphAlignmentLeft") },
                                                            { actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.ToggleParagraphAlignmentCenter, icon: " dxre-icon-AlignCenter", hint: DevExpress.Analytics.Utils.getLocalization("Center", "XtraRichEditStringId.MenuCmd_ParagraphAlignmentCenter") },
                                                            { actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.ToggleParagraphAlignmentRight, icon: " dxre-icon-AlignRight", hint: DevExpress.Analytics.Utils.getLocalization("Align Text Right", "XtraRichEditStringId.MenuCmd_ParagraphAlignmentRight") }
                                                        ]
                                                    },
                                                    {
                                                        id: RichEdit.ToolbarActionId.HyperlinkButton, actionType: "Button", command: DevExpress.RichEdit.InsertTabCommandId.ShowHyperlinkDialog, icon: " dxre-icon-Hyperlink", hint: DevExpress.Analytics.Utils.getLocalization("Hyperlink...", "XtraRichEditStringId.MenuCmd_Hyperlink"),
                                                    },
                                                    {
                                                        id: RichEdit.ToolbarActionId.ClearFormattingButton, actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.ClearFormatting, icon: " dxre-icon-ClearFormatting", hint: DevExpress.Analytics.Utils.getLocalization("Clear Formatting", "XtraRichEditStringId.MenuCmd_ClearFormatting")
                                                    }
                                                ],
                                            },
                                            {
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        items: [
                                                            { actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.ToggleFontBold, icon: " dxre-icon-Bold", hint: DevExpress.Analytics.Utils.getLocalization("Bold", "System.Drawing.Font.Bold") },
                                                            { actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.ToggleFontItalic, icon: " dxre-icon-Italic", hint: DevExpress.Analytics.Utils.getLocalization("Italic", "System.Drawing.Font.Italic") },
                                                            { actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.ToggleFontUnderline, icon: " dxre-icon-Underline", hint: DevExpress.Analytics.Utils.getLocalization("Underline", "System.Drawing.Font.Underline") },
                                                            { actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.ToggleFontStrikeout, icon: " dxre-icon-Strikeout", hint: DevExpress.Analytics.Utils.getLocalization("Strikeout", "System.Drawing.Font.Strikeout") }
                                                        ]
                                                    },
                                                    { id: RichEdit.ToolbarActionId.ToggleCaseButton, actionType: "Button", command: DevExpress.RichEdit.HomeTabCommandId.CapitalizationToggleCase, icon: " dxre-icon-ChangeTextCase", hint: DevExpress.Analytics.Utils.getLocalization("tOGGLE cASE", "XtraRichEditStringId.MenuCmd_ToggleTextCase") }
                                                ]
                                            },
                                            {
                                                ...
                                                items: [{ id: RichEdit.ToolbarActionId.FontSizeComboBox, actionType: "ComboBox", command: DevExpress.RichEdit.HomeTabCommandId.ChangeFontSize, items: [8, 9, 10, 11, 12, 14, 16, 18, 20, 24, 26, 28, 36, 48, 72] }],
                                            },
                                            {
                                                ...
                                                items: [{ id: RichEdit.ToolbarActionId.FontComboBox, actionType: "ComboBox", command: DevExpress.RichEdit.HomeTabCommandId.ChangeFontName, items: fonts }],
                                            },
                                            {
                                                ...
                                                items: [{ id: RichEdit.ToolbarActionId.FontColorBox, actionType: "ColorBox", command: DevExpress.RichEdit.HomeTabCommandId.ChangeFontForeColor, defaultValue: "rgb(0, 0, 0)" }],
                                            },
                                            {
                                                ...
                                                items: [{ id: RichEdit.ToolbarActionId.BackgroundColorBox, actionType: "ColorBox", command: DevExpress.RichEdit.HomeTabCommandId.ChangeFontHighlightColor, defaultValue: "rgb(255, 255, 255)" }]
                                            }
                                        ];
                                    };
