        ...
        (function (Viewer) {
            ...
            (function (Internal) {
                ...
                var PreviewPage = (function (_super) {
                    ...
                    function PreviewPage(preview, pageIndex, processClick, loading) {
                        ...
                        _this_1._disposables.push(_this_1.imageSrc.subscribe(function (newVal) {
                            ...
                            _this_1._lastGetPageDeferred && _this_1._lastGetPageDeferred.resolve(null);
                            ...
                            _this_1._lastGetPageDeferred = currentGetPageDeferred;
                        }));
                ...
                function createDesktopPreview(element, callbacks, parametersInfo, handlerUri, previewVisible, applyBindings, allowURLsWithJSContent, rtl, tabPanelSettings, progressBarSettings) {
                    ...
                    if (tabPanelSettings) {
                        tabPanelSettings.width && tabPanel.width(parseInt(tabPanelSettings.width));
                ...
                Internal.createPreviewModel = createPreviewModel;
                ...
                Internal.initPreviewModel = initPreviewModel;
            })(Internal = Viewer.Internal || (Viewer.Internal = {}));
            var Parameters;
            (function (Parameters) {
            ...
            (function (Widgets) {
                ...
                function createRangeItem(displayName, localizationId, range) {
                    var item = {
                        displayName: DevExpress.Analytics.Utils.getLocalization(displayName, localizationId),
                        range: range
                    };
                    Object.defineProperty(item, 'displayName', {
                        get: function () { return DevExpress.Analytics.Utils.getLocalization(displayName, localizationId); },
                        configurable: true
                    });
                    return item;
                }
                Widgets.predefinedDateRanges = [
                ...
                var DateRangeEditor = (function (_super) {
                    ...
                    function DateRangeEditor(_options) {
                        ...
                        _this_1.items = Widgets.predefinedDateRanges;
            ...
            (function (Export) {
                ...
                var docxExportOptionsSerializationInfoPreview = [
                    ...
                    Reporting.Export.Metadata.exportPageBreaks,
            ...
            var ReportPreview = (function (_super) {
                    ...
                    _initializeDeferred.done(function () {
                        initializeDataPromise.done(function (previewInitialize) {
                            ...
                            if (previewInitialize && !previewInitialize.error && (previewInitialize.reportId || previewInitialize.documentId)) {
                                ...
                                _this_1._processError(DevExpress.Analytics.Utils.getLocalization("The report preview initialization has failed", "ASPxReportsStringId.WebDocumentViewer_InitializationError"), previewInitialize && previewInitialize.error);
                            }
                        }).fail(function (error) {
                            _this_1.reportOpening(false);
                ...
                ReportPreview.prototype.emptyDocumentCaption = function () {
                    ...
                    if (this.documentBuilding()) {
                        ...
                        return DevExpress.Analytics.Utils.getLocalization('Loading...', 'AnalyticsCoreStringId.Loading');
                    }
                ...
                (function (Internal) {
                    ...
                    var ParametersPopupModel = (function (_super) {
                        ...
                        function ParametersPopupModel(model, _reportPreview) {
                            ...
                            _this_1._disposables.push(ko.computed(function () {
                                _this_1.cancelDisabled(!_this_1._reportPreview._currentDocumentId() || _this_1._reportPreview.pages().length === 0);
                            }));
            ...
            var JSReportViewerBinding = (function (_super) {
                ...
                JSReportViewerBinding.prototype._createModel = function (element) {
                    ...
                    return Internal.createPreviewModel(this._options, element, this._callbacks, false);
                };
                JSReportViewerBinding.prototype.applyBindings = function (element) {
                    ...
                    var applyModel = function () {
                        ...
                        _this_1._deferreds.push(_this_1._createModel(element)
                            ...
                            _this_1.sender.previewModel = previewModel;
                            ...
                            Internal.initPreviewModel(previewModel, _this_1._options);
                        }));
                    };
                    if (requestOptions) {
