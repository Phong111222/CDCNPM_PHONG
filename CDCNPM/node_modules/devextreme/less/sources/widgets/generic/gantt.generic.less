...
.dx-gantt {
    ...
    .dx-treelist-text-content {
        min-height: @GANTT_TREELIST_TEXT_MIN_HEIGHT;
    }

    .dx-treelist-icon-container {
        max-height: @GANTT_TREELIST_TEXT_MIN_HEIGHT;
    }
...
.dx-form {
    &.dx-cv-dialog {
        padding-bottom: @GANTT_CV_DIALOG_PADDING_BOTTOM;

        .dx-cv-dialog-row {
            padding-top: @GANTT_CV_DIALOG_ROW_PADDING_TOP;
        }
    }
}
