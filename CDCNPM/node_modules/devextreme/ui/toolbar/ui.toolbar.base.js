...
var ToolbarBase = _uiCollection_widget2.default.inherit({
    ...
    _renderToolbar: function() {
        this.$element().addClass(_constants.TOOLBAR_CLASS).toggleClass(TOOLBAR_BOTTOM_CLASS, "bottomToolbar" === this.option("renderAs")).toggleClass(TOOLBAR_MULTILINE_CLASS, this.option("multiline"));
