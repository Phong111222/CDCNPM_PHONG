                        ...
                        return result && result.done(function() {
                            if (isVirtualMode(that) || isVirtualRowRendering(that)) {
                                ...
                                if (scrollable && !that.option("legacyRendering") && !isSortingOperation) {
                                    ...
                                    var isChromeLatest = _browser2.default.chrome && _browser2.default.version >= 91;
                                    var allowedTopOffset = _browser2.default.mozilla || _browser2.default.msie || isChromeLatest ? 1 : 0;
