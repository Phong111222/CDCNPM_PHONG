...
var isIE11 = _browser2.default.msie && parseInt(_browser2.default.version) <= 11;
var Calendar = _editor2.default.inherit({
    ...
    _supportedKeys: function() {
        return (0, _extend.extend)(this.callBase(), {
            ...
            home: function(e) {
                ...
                var date = _date3.default.sameView(zoomLevel, currentDate, min) ? min : _date3.default.getViewFirstCellDate(zoomLevel, currentDate);
                ...
                var date = _date3.default.sameView(zoomLevel, currentDate, max) ? max : _date3.default.getViewLastCellDate(zoomLevel, currentDate);
                this._moveToClosestAvailableDate(date)
            },
            pageUp: function(e) {
                e.preventDefault();
    ...
    _moveToClosestAvailableDate: function() {
        ...
        var currentDate = _date3.default.createDate(baseDate);
        var zoomLevel = this.option("zoomLevel");
        ...
        var dateForward = _date3.default.createDate(currentDate);
        var dateBackward = _date3.default.createDate(currentDate);
        do {
    ...
    _getNormalizedDate: function(date) {
        date = _date3.default.normalizeDate(date, this._getMinDate(), this._getMaxDate());
        return _type2.default.isDefined(date) ? this._getDate(date) : date
    },
    ...
    _updateCurrentDate: function(date) {
        ...
        if (date.getTime() !== normalizedDate.getTime()) {
            this.option("currentDate", _date3.default.createDate(normalizedDate));
            return
        }
    ...
    _getDateByOffset: function(offset, date) {
        ...
        var difference = _date3.default.getDifferenceInMonth(this.option("zoomLevel")) * offset;
        date.setDate(1);
        date.setMonth(date.getMonth() + difference);
        var lastDay = _date3.default.getLastMonthDate(date).getDate();
    ...
    _isViewAvailable: function(date) {
        var zoomLevel = this.option("zoomLevel");
        var min = _date3.default.getViewMinBoundaryDate(zoomLevel, this._getMinDate());
        var max = _date3.default.getViewMaxBoundaryDate(zoomLevel, this._getMaxDate());
        return _date3.default.dateInRange(date, min, max)
    },
    ...
    _cellClickHandler: function(e) {
        var zoomLevel = this.option("zoomLevel");
        var nextView = _date3.default.getViewDown(zoomLevel);
    ...
    _updateTimeComponent: function(date) {
        var result = _date3.default.createDate(date);
    ...
    _navigateUp: function() {
        var zoomLevel = this.option("zoomLevel");
        var nextView = _date3.default.getViewUp(zoomLevel);
    ...
    _isMinZoomLevel: function(zoomLevel) {
        var min = this._getMinDate();
        var max = this._getMaxDate();
        return _date3.default.sameView(zoomLevel, min, max) || this.option("minZoomLevel") === zoomLevel
    },
    ...
    _isDateInInvalidRange: function(date) {
        ...
        var min = this._getMinDate();
        var max = this._getMaxDate();
        var normalizedDate = _date3.default.normalizeDate(date, min, max);
    ...
    _getDate: function(value) {
        var result = _date3.default.createDate(value);
        if (isIE11 && _type2.default.isDate(value)) {
    ...
    _optionChanged: function(args) {
        ...
        switch (args.name) {
            ...
            case "value":
                ...
                this.option("currentDate", _type2.default.isDefined(value) ? _date3.default.createDate(value) : new Date);
