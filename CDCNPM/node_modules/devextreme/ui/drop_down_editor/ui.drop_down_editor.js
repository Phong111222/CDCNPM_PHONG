...
var DropDownEditor = _text_box2.default.inherit({
    ...
    _wrapInput: function() {
        this._$container = this.$element().wrapInner((0, _renderer2.default)("<div>").addClass(DROP_DOWN_EDITOR_INPUT_WRAPPER)).children().eq(0)
    },
    ...
    _refreshEmptinessEvent: function() {
        _events_engine2.default.off(this._input(), "input blur", this._toggleEmptinessEventHandler);
    ...
    _popupConfig: function() {
        ...
        return {
            ...
            width: function() {
                return (0, _utils2.getElementWidth)(_this4.$element())
            },
            height: "auto",
            shading: false,
    ...
    _dimensionChanged: function() {
        var _this6 = this;
        var popupWidth = (0, _utils2.getSizeValue)(this.option("dropDownOptions.width"));
        if (void 0 === popupWidth) {
            this._setPopupOption("width", function() {
                return (0, _utils2.getElementWidth)(_this6.$element())
            })
        }
    },
