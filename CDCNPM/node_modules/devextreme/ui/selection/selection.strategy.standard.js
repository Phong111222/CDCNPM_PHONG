...
var isKeysEqual = require("../../core/utils/array_compare").isKeysEqual;
...
module.exports = SelectionStrategy.inherit({
        ...
        if (multiSelectEnabled) {
            if (this._requestInProgress()) {
                if (isDeselectAll) {
                    ...
                    if (!isKeysEqual(keys, this.options.selectedItemKeys)) {
    ...
    _updateKeysByLastRequestData: function(keys, isDeselect, isSelectAll) {
        ...
        if (this._isMultiSelectEnabled() && !isDeselect && !isSelectAll) {
            ...
            currentKeys = arrayUtils.removeDuplicates(keys.concat(null === (_this$_lastRequestDat = this._lastRequestData) || void 0 === _this$_lastRequestDat ? void 0 : _this$_lastRequestDat.addedItems), null === (_this$_lastRequestDat2 = this._lastRequestData) || void 0 === _this$_lastRequestDat2 ? void 0 : _this$_lastRequestDat2.removedItems);
