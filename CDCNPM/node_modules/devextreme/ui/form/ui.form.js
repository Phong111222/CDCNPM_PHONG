...
var Form = _ui2.default.inherit({
    ...
    _applyLabelsWidthByCol: function($container, index, options, layoutManager) {
        ...
        for (i = 0; i < $labelTextsLength; i++) {
            labelWidth = (0, _uiForm7.getLabelWidthByText)(layoutManager._getRenderLabelOptions({
    ...
    _alignLabels: function(layoutManager, inOneColumn) {
        ...
        (0, _dom.triggerResizeEvent)(this.$element().find(".".concat(_constants2.TOOLBAR_CLASS)))
    },
    _clean: function() {
        this.callBase();
        this._groupsColCount = [];
    ...
    _renderValidationSummary: function() {
        ...
        if (this.option("showValidationSummary")) {
            var _$validationSummary = (0, _renderer2.default)("<div>").addClass(_constants.FORM_VALIDATION_SUMMARY).appendTo(this._getContent());
    ...
    _itemTabbedTemplate: function(item, e, $container) {
        ...
        (0, _renderer2.default)($container).parent().addClass(_constants.FIELD_ITEM_CONTENT_HAS_TABS_CLASS);
    ...
    _itemGroupTemplate: function(item, e, $container) {
        var $group = (0, _renderer2.default)("<div>").toggleClass(_constants.FORM_GROUP_WITH_CAPTION_CLASS, (0, _type.isDefined)(item.caption) && item.caption.length).addClass(_constants.FORM_GROUP_CLASS).appendTo($container);
        (0, _renderer2.default)($container).parent().addClass(_constants.FIELD_ITEM_CONTENT_HAS_GROUP_CLASS);
        var colCount;
        var layoutManager;
        if (item.caption) {
            (0, _renderer2.default)("<span>").addClass(_constants.FORM_GROUP_CAPTION_CLASS).text(item.caption).appendTo($group)
        }
        var $groupContent = (0, _renderer2.default)("<div>").addClass(_constants.FORM_GROUP_CONTENT_CLASS).appendTo($group);
    ...
    itemOption: function(id, option, value) {
        ...
        var path = (0, _uiForm7.getItemPath)(items, item);
        if (!item) {
            return
        }
