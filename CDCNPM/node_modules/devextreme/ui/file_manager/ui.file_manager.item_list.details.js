            ...
            if (this._isDefaultColumn(columnOptions.dataField)) {
                ...
                switch (columnOptions.dataField) {
                    ...
                    case "name":
                        ...
                        defaultConfig.caption = _message2.default.format("dxFileManager-listDetailsColumnCaptionName");
                        break;
                    case "size":
                        defaultConfig.calculateCellValue = this._calculateSizeColumnCellValue.bind(this);
                        defaultConfig.caption = _message2.default.format("dxFileManager-listDetailsColumnCaptionFileSize");
                        break;
                    case "dateModified":
                        defaultConfig.caption = _message2.default.format("dxFileManager-listDetailsColumnCaptionDateModified")
