...
var FileManagerAdaptivityControl = function(_Widget) {
    ...
    _createClass(FileManagerAdaptivityControl, [{
        ...
        value: function(width) {
            (0, _renderer2.default)(this._drawer.content()).css("width", width);
            this._updateDrawerMaxSize();
        ...
        value: function() {
            ...
            if (oldState !== this._isInAdaptiveState) {
                ...
                (0, _renderer2.default)(this._drawer.content()).toggleClass(DRAWER_PANEL_CONTENT_ADAPTIVE, this._isInAdaptiveState);
