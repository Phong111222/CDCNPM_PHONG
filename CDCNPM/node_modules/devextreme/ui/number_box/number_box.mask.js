...
var _require2 = require("./utils"),
    getRealSeparatorIndex = _require2.getRealSeparatorIndex,
    getNthOccurrence = _require2.getNthOccurrence,
    splitByIndex = _require2.splitByIndex;
...
var NumberBoxMask = NumberBoxBase.inherit({
    ...
    _shouldHandleKey: function(e) {
        ...
        var isSpecialChar = eventUtils.isCommandKeyPressed(e) || e.altKey || e.shiftKey || !this._isChar(keyName);
