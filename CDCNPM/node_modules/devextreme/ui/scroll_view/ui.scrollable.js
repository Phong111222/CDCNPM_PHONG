    ...
    _updateRtlPosition: function() {
        ...
        if (this._isHorizontalAndRtlEnabled()) {
            _common2.default.deferUpdate(function() {
                ...
                var scrollLeft = containerElement.scrollWidth - containerElement.clientWidth - _this._rtlConfig.scrollRight;
                if (scrollLeft <= 0) {
                    scrollLeft = 0;
                    _this._rtlConfig.scrollRight = containerElement.scrollWidth - containerElement.clientWidth
                }
    ...
    _updateRtlConfig: function() {
        if (this._isHorizontalAndRtlEnabled() && !this._rtlConfig.skipUpdating) {
            var _this$_container$get = this._container().get(0),
                ...
                scrollLeft = _this$_container$get.scrollLeft;
