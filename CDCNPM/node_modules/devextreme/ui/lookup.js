...
var _require2 = require("./drop_down_editor/utils"),
    getElementWidth = _require2.getElementWidth;
        ...
        if (isSearchEnabled) {
            ...
            this._searchBox = this._createComponent($searchBox, TextBox, {
                ...
                onKeyboardHandled: function(opts) {
                    return isKeyboardListeningEnabled && _this2._list._keyboardHandler(opts)
                },
                mode: searchMode,
