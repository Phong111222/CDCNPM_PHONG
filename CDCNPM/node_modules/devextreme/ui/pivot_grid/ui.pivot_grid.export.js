...
exports.PivotGridExport = void 0;
...
exports.DataProvider = _class2.default.inherit({
    ...
    getCellDataType: function(field) {
        ...
        if (field.format) {
            if (1 === _number2.default.parse(_format_helper2.default.format(1, field.format))) {
                return "number"
            }
            if (_format_helper2.default.format(new Date, field.format)) {
                return "date"
            }
        }
