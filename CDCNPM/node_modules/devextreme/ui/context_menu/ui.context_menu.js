    ...
    _createClass(ContextMenu, [{
        ...
        value: function($element) {
            if ($element && 0 !== $element.length) {
                this.option("focusedElement", (0, _dom.getPublicElement)($element))
            }
        }
    }, {
        ...
        value: function() {
            ...
            var eventName = (0, _utils.addNamespace)(_contextmenu.name, this.NAME);
            _events_engine2.default.off($itemContainer, eventName, ".".concat(DX_SUBMENU_CLASS));
            _events_engine2.default.on($itemContainer, eventName, ".".concat(DX_SUBMENU_CLASS), function(e) {
                e.stopPropagation();
                e.preventDefault();
                _events_engine2.default.off($itemContainer, eventName, ".".concat(DX_SUBMENU_CLASS))
            }.bind(this))
        ...
        value: function(event) {
            ...
            if (position) {
                ...
                if ((null === event || void 0 === event ? void 0 : null === (_event$originalEvent = event.originalEvent) || void 0 === _event$originalEvent ? void 0 : _event$originalEvent.type) === _hold2.default.name) {
