...
var isCommandKeyPressed = require("../../events/utils/index").isCommandKeyPressed;
    ...
    _renderPaletteHandle: function() {
        ...
        this._createComponent(this._$paletteHandle, Draggable, {
            ...
            onDragMove: function(_ref) {
                ...
                var paletteHandlePosition = translator.locate(_this._$paletteHandle);
    ...
    _renderHueScaleHandle: function() {
        ...
        this._createComponent(this._$hueScaleHandle, Draggable, {
            ...
            onDragMove: function(_ref2) {
                ...
                _this2._updateColorHue(translator.locate(_this2._$hueScaleHandle).top + _this2._hueScaleHandleHeight / 2)
            }
        });
    ...
    _renderAlphaChannelHandle: function($parent) {
        ...
        this._createComponent(this._$alphaChannelHandle, Draggable, {
            ...
            onDragMove: function(_ref3) {
                ...
                var alphaChannelHandlePosition = translator.locate($alphaChannelHandle).left + _this4._alphaChannelHandleWidth / 2;
