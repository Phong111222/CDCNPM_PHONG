        ...
        value: function(dataSourceName, data) {
            ...
            if (dataSourceName === GANTT_TASKS) {
                ...
                var expandedRowKeys = data.map(function(t) {
                    return t[_this6.option("tasks.parentIdExpr")]
        ...
        value: function() {
            ...
            return {
                NotifyTaskCreated: function(task, callback, errorCallback) {
                    _this7._onRecordInserted(GANTT_TASKS, task, callback)
                },
                NotifyTaskRemoved: function(taskId, errorCallback) {
                    _this7._onRecordRemoved(GANTT_TASKS, taskId)
                },
                NotifyTaskTitleChanged: function(taskId, newValue, errorCallback) {
                    _this7._onRecordUpdated(GANTT_TASKS, taskId, "title", newValue)
                },
                NotifyTaskDescriptionChanged: function(taskId, newValue, errorCallback) {
                    _this7._onRecordUpdated(GANTT_TASKS, taskId, "description", newValue)
                },
                NotifyTaskStartChanged: function(taskId, newValue, errorCallback) {
                    _this7._onRecordUpdated(GANTT_TASKS, taskId, "start", newValue)
                },
                NotifyTaskEndChanged: function(taskId, newValue, errorCallback) {
                    _this7._onRecordUpdated(GANTT_TASKS, taskId, "end", newValue)
                },
                NotifyTaskProgressChanged: function(taskId, newValue, errorCallback) {
                    _this7._onRecordUpdated(GANTT_TASKS, taskId, "progress", newValue)
                },
                NotifyDependencyInserted: function(dependency, callback, errorCallback) {
                    _this7._onRecordInserted(GANTT_DEPENDENCIES, dependency, callback)
                },
                NotifyDependencyRemoved: function(dependencyId, errorCallback) {
                    _this7._onRecordRemoved(GANTT_DEPENDENCIES, dependencyId)
                },
                NotifyResourceCreated: function(resource, callback, errorCallback) {
                    _this7._onRecordInserted(GANTT_RESOURCES, resource, callback)
                },
                NotifyResourceRemoved: function(resource, errorCallback) {
                    _this7._onRecordRemoved(GANTT_RESOURCES, resource)
                },
                NotifyResourceAssigned: function(assignment, callback, errorCallback) {
                    _this7._onRecordInserted(GANTT_RESOURCE_ASSIGNMENTS, assignment, callback)
                },
                NotifyResourceUnassigned: function(assignmentId, errorCallback) {
                    _this7._onRecordRemoved(GANTT_RESOURCE_ASSIGNMENTS, assignmentId)
                },
                NotifyParentDataRecalculated: function(data) {
                    _this7._onParentTasksRecalculated(data)
                }
            }
        }
    }, {
        ...
        value: function(optionName, record, callback) {
            ...
            if (dataOption) {
                ...
                dataOption.insert(data, function(response) {
                    var keyGetter = _data2.default.compileGetter(_this8.option("".concat(optionName, ".keyExpr")));
                    ...
                    if (optionName === GANTT_TASKS) {
                        ...
                        if (void 0 !== parentId) {
                            var expandedRowKeys = _this8._treeList.option("expandedRowKeys");
                            if (expandedRowKeys.indexOf(parentId) === -1) {
                                expandedRowKeys.push(parentId);
                                _this8._treeList.option("expandedRowKeys", expandedRowKeys)
                            }
                        }
                        _this8._setTreeListOption("selectedRowKeys", _this8._getArrayFromOneElement(insertedId));
                        _this8._setTreeListOption("focusedRowKey", insertedId)
                    }
                })
            }
        }
