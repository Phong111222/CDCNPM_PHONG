...
var TagBox = _select_box2.default.inherit({
    ...
    _initDynamicTemplates: function() {
        ...
        this._templateManager.addDefaultTemplates({
            tag: new _bindable_template.BindableTemplate(function($container, data) {
                ...
                (0, _renderer2.default)("<span>").text(null !== (_data$text = data.text) && void 0 !== _data$text ? _data$text : data).appendTo($tagContent);
    ...
    _tagContainerMouseWheelHandler: function(e) {
        ...
        if (!(0, _utils.isCommandKeyPressed)(e) && (0, _utils5.allowScroll)(this._$tagsContainer, delta, true)) {
    ...
    _renderTypingEvent: function() {
        ...
        var namespace = (0, _utils.addNamespace)("keydown", this.NAME);
        _events_engine2.default.off(input, namespace);
        _events_engine2.default.on(input, namespace, function(e) {
