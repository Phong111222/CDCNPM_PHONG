...
var DateBoxMask = _uiDate_box2.default.inherit({
    ...
    _isSingleCharKey: function(_ref) {
        var originalEvent = _ref.originalEvent,
            alt = _ref.alt;
        var key = originalEvent.data || ("space" === (0, _utils.normalizeKeyName)(originalEvent) ? " " : originalEvent.key);
        return "string" === typeof key && 1 === key.length && !alt && !(0, _utils.isCommandKeyPressed)(originalEvent)
    },
